...
public class MainActivity extends FragmentActivity implements LocationListener,
    ...
    private ParseQueryAdapter<MessagePost> postsQueryAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ParseQueryAdapter.QueryFactory<MessagePost> factory =
                new ParseQueryAdapter.QueryFactory<MessagePost>() {
                    public ParseQuery<MessagePost> create() {
                        Location myLoc = (currentLocation == null) ? lastLocation : currentLocation;
                        ParseQuery<MessagePost> query = MessagePost.getQuery();
                        query.include("user");
        ...
        postsQueryAdapter = new ParseQueryAdapter<MessagePost>(this, factory) {
            @Override
            public View getItemView(MessagePost post, View view, ViewGroup parent) {
                if (view == null) {
                    view = View.inflate(getContext(), R.layout.message_post_item, null);
                }
        ...
        postsListView.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                final MessagePost item = postsQueryAdapter.getItem(position);
    ...
    private void doMapQuery() {
        ...
        ParseQuery<MessagePost> mapQuery = MessagePost.getQuery();
        ...
        mapQuery.findInBackground(new FindCallback<MessagePost>() {
            @Override
            public void done(List<MessagePost> objects, ParseException e) {
                if (e != null) {
                    if (Application.APPDEBUG) {
