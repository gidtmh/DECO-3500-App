...
public class MainActivity extends FragmentActivity implements LocationListener,
    ...
    private ParseQueryAdapter<CrumbpinsPost> postsQueryAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ParseQueryAdapter.QueryFactory<CrumbpinsPost> factory =
                new ParseQueryAdapter.QueryFactory<CrumbpinsPost>() {
                    public ParseQuery<CrumbpinsPost> create() {
                        Location myLoc = (currentLocation == null) ? lastLocation : currentLocation;
                        ParseQuery<CrumbpinsPost> query = CrumbpinsPost.getQuery();
                        query.include("user");
        ...
        postsQueryAdapter = new ParseQueryAdapter<CrumbpinsPost>(this, factory) {
            @Override
            public View getItemView(CrumbpinsPost post, View view, ViewGroup parent) {
                if (view == null) {
                    view = View.inflate(getContext(), R.layout.crumbpins_post_item, null);
                }
        ...
        postsListView.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                final CrumbpinsPost item = postsQueryAdapter.getItem(position);
    ...
    private void doMapQuery() {
        ...
        ParseQuery<CrumbpinsPost> mapQuery = CrumbpinsPost.getQuery();
        ...
        mapQuery.findInBackground(new FindCallback<CrumbpinsPost>() {
            @Override
            public void done(List<CrumbpinsPost> objects, ParseException e) {
                if (e != null) {
                    if (Application.APPDEBUG) {
         ...
         */
                ...
                for (CrumbpinsPost post : objects) {
